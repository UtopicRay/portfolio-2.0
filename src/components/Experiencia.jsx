    ...
    >
      <div className="p-6">
        ...
        <p className="my-4">
          ...
          creación de API Rest, validación de formularios, el manejo de
          información de bases de datos y la implementación de un sistema de
          recomendación utilizando PHP como lenguaje de programación. Sin
          embargo, no he tenido la oportunidad de trabajar fuera del entorno
          escolar, por lo que espero seguir aprendiendo y mejorando mis
